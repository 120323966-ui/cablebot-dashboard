...
export function createHomeOverviewMock(): HomeOverviewResponse {
  return {
    ...
    risk: {
      ...
      rows: ['北侧', '中段', '南侧'],
      cells: [
        { x: 0, y: 0, risk: 0.2, label: '正常' },
        { x: 1, y: 0, risk: 0.28, label: '稳定' },
        { x: 2, y: 0, risk: 0.36, label: '轻微升温' },
        { x: 3, y: 0, risk: 0.44, label: '观察' },
        { x: 4, y: 0, risk: 0.91, label: '重点复核' },
        { x: 5, y: 0, risk: 0.42, label: '观察' },
        { x: 6, y: 0, risk: 0.55, label: '积水风险' },
        { x: 7, y: 0, risk: 0.34, label: '稳定' },
        { x: 0, y: 1, risk: 0.18, label: '正常' },
        { x: 1, y: 1, risk: 0.23, label: '正常' },
        { x: 2, y: 1, risk: 0.29, label: '稳定' },
        { x: 3, y: 1, risk: 0.41, label: '观察' },
        { x: 4, y: 1, risk: 0.77, label: '高温回落中' },
        { x: 5, y: 1, risk: 0.39, label: '稳定' },
        { x: 6, y: 1, risk: 0.82, label: '潮湿异常' },
        { x: 7, y: 1, risk: 0.31, label: '正常' },
        { x: 0, y: 2, risk: 0.12, label: '正常' },
        { x: 1, y: 2, risk: 0.2, label: '正常' },
        { x: 2, y: 2, risk: 0.27, label: '稳定' },
        { x: 3, y: 2, risk: 0.33, label: '稳定' },
        { x: 4, y: 2, risk: 0.58, label: '待复核' },
        { x: 5, y: 2, risk: 0.31, label: '稳定' },
        { x: 6, y: 2, risk: 0.63, label: '湿度偏高' },
        { x: 7, y: 2, risk: 0.26, label: '正常' },
      ],
    },
    trends: [
